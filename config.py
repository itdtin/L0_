...
BRIDGE_BALANCE_WAIT_TIME: int = 3600 # 20000 seconds

SWAP_SLIPPAGE: int = 5
# Wait
WAIT_BTW_WALLET_MIN: int = 1200
WAIT_BTW_WALLET_MAX: int = 2000

WAIT_BTW_PROJECT_MIN: int = 30
WAIT_BTW_PROJECT_MAX: int = 130

WAIT_RECEIPT = [(4,5), (7,8)]
WAIT_RECEIPT_POLYGON = [(4,5), (7,8)]
